...
- platform.claude.com (API/SDK docs)
...
def main() -> int:
    ...
    for i, (name, llms_url, strip) in enumerate(SOURCES, 1):
        ...
        # Fetch docs_map for code.claude.com
        docs_map = None
        if name == "code-claude-com":
            try:
        ...
        for j, url in enumerate(urls, 1):
            ...
            # SDK language filter (platform.claude.com only)
            if name == "platform-claude-com" and SDK_SKIP.match(str(rel_path)):
